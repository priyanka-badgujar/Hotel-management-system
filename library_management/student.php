...
<body>
	...
	<center>
		<a href="add_stud.php"><button id="z1" class="btnLogin">ADD</button></a></br></br>
		<a href="display_stud.php"><button id="z1" class="btnLogin">DISPLAY</button></a> </br></br>
		<a href="edit_stud.php"><button id="z1" class="btnLogin">EDIT</button></a></br></br>
		<a href="delete_stud.php"><button id="z1" class="btnLogin">DELETE</button></a></br></br>
	</center>
